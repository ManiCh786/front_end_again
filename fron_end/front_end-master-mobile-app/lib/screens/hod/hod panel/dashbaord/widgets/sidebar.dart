...
class CoursesSideBar extends StatelessWidget {
  const CoursesSideBar({super.key, required SidebarXController controller})
  ...
  Widget build(BuildContext context) {
    return SidebarX(
      ...
      items: const [
        ...
        SidebarXItem(icon: Icons.person_search, label: 'Lectures Outline'),
        SidebarXItem(icon: Icons.file_upload_sharp, label: 'Assessments'),
        SidebarXItem(icon: Icons.assessment, label: 'Results')
      ],
    );
  }
}
