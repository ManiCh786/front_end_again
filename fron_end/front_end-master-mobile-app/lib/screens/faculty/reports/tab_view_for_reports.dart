...
import 'package:front_end/screens/faculty/reports/view_objectives_report.dart';
import 'package:get/get.dart';
import '../../../../controllers/controller.dart';
import '../../../../models/models.dart';
import '../../../../widgets/widgets.dart';
import '../faculty_Dashboard/Objectives/add_objectives.dart';

class TabViewForReports extends StatelessWidget {
  TabViewForReports({Key? key, this.courses}) : super(key: key);
                    ...
                    child: Padding(
                      ...
                      child: TabBarView(children: [
                        ViewObjectivesReport(
                          ...
                          courseName: courseController.myCourses
                              .where((e) => e.courseId
                                  .toString()
                                  .contains(courseId.toString()))
                              .map((e) => e.courseName)
                              .toString(),
                          session: courseController.myCourses
                              .where((e) => e.courseId
                                  .toString()
                                  .contains(courseId.toString()))
                              .map((e) => e.session)
